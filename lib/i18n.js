...
const translations = {
  uk: {
    ...
    fCredit: "Кредит / розстрочка",
    fCreditMode: "Як вказати суму",
    creditNone: "немає",
    creditYes: "є",
    creditYesSub: "кредит/розстрочка",
    creditModePct: "% від зарплати",
    creditModeFixed: "сума грн/міс",
    uahPerMo: "грн/міс",
    ...
    sumCreditNote: (amount) => `включно з виплатою по кредиту: ${amount.toLocaleString("uk-UA")} грн/міс`,
    ...
    logCredit: (amount) => `Виплата кредит/розстрочка −${amount.toLocaleString("uk-UA")} грн`,
  ...
  en: {
    ...
    fCredit: "Credit / installments",
    fCreditMode: "How to enter the amount",
    creditNone: "none",
    creditYes: "yes",
    creditYesSub: "loan/installment plan",
    creditModePct: "% of salary",
    creditModeFixed: "amount UAH/mo",
    uahPerMo: "UAH/mo",
    ...
    sumCreditNote: (amount) => `includes credit/installment payment: ${amount.toLocaleString("en-US")} UAH/mo`,
    ...
    // Log labels
    logCredit: (amount) => `Credit/installment payment −${amount.toLocaleString("en-US")} UAH`,
